//7642 Retail	Extra-Heavy (more than 45,000 lbs)	Yes	90000	00726	105	Farmers	All Other	404	69
...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    //FAKE BEGGINING
    //Add first name
    cy.get("input#Prospect\\.Name\\.FirstName").clear().type("CommercialExtra7642");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("CommercialExtra7642");
