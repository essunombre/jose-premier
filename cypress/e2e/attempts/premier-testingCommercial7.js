//7738 Service	Extra-Heavy (more than 45,000 lbs)	No	90000	00986	101	Contractors	Excavating	401	84
...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    //FAKE BEGGINING
    //Add first name
    cy.get("input#Prospect\\.Name\\.FirstName").clear().type("CommercialExtra7738");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("CommercialExtra7738");
