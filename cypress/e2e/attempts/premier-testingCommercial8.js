//8423 Service	Extra-Heavy (more than 45,000 lbs)	Yes	6000	00726	105	Waste Disposal	Junk Dealers	404	54
...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    //FAKE BEGGINING
    //Add first name
    cy.get("input#Prospect\\.Name\\.FirstName").clear().type("CommercialExtra8423");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("CommercialExtra8423");
