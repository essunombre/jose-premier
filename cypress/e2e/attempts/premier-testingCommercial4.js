//6415 Commercial	Extra-Heavy (more than 45,000 lbs)	No	90000	00986	101	Trucks	Exempt Carriers	401	24    -25?
...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    // //FAKE BEGGINING
    // //Add first name
    // cy.get("input#Prospect\\.Name\\.FirstName").clear().type("CommercialExtra6415");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("CommercialExtra6415");
