//4913 Commercial	Heavy (20,001 - 45,000 lbs)	Yes	6000	00726	105	Waste Disposal	Junk Dealers	334	54
...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    //FAKE BEGGINING
    //Add first name
    cy.get("input#Prospect\\.Name\\.FirstName").clear().type("CommercialHeavy4913");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("CommercialHeavy4913");
    ...
    cy.get('input[name="Vehicle.ActualValue"]').type("40000");
