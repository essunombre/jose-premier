...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    //FAKE BEGGINING
    //Add first name
    cy.get("input#Prospect\\.Name\\.FirstName").clear().type("QuoteStatus2");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("QuoteStatusCom");
    ...
    cy.get("input#Prospect\\.Email")
      .clear()
      .type("olafpekerman+QuoteStatusCom@gmail.com");
