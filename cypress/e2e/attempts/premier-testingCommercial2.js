//1217 Retail	Medium (10,001 - 20,000 lbs)	Yes	6000	00780	103	Farmers	Livestock Hauling	224	62
...
describe("Automating Commercial policy", () => {
  ...
  it.only("Verifying frontend policies payment", () => {
    ...
    //FAKE BEGGINING
    //Add first name
    cy.get("input#Prospect\\.Name\\.FirstName").clear().type("CommercialMedium1217");
    ...
    //Adding Company Name
    //     //Add first name
    cy.get("input#Prospect\\.CompanyName").clear().type("CommercialMedium1217");
